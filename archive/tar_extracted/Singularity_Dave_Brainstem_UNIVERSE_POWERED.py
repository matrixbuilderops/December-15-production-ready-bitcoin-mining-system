...
# =====================================================
# ALL MODES (demo, test, sandbox, live) use THIS configuration
...
MINING_MATH_CONFIG = {
    ...
    "mode_specific_behavior": {
        "demo": {
            ...
            "use_real_template": True,  # But template is from real Bitcoin network
        ...
        "sandbox": {
            "use_real_math": True,  # Sandbox uses full production math
            "use_real_template": True,  # Real template from Bitcoin node
            "create_hierarchical_files": True,
            "submit_to_network": False,  # Does NOT submit (testing production setup)
            "output_folder": "Mining",  # Uses production folders
        },
        "live": {
...
def brain_get_math_config(mode="live"):
    ...
    Args:
        mode: One of "demo", "test", "sandbox", "live"
...
ENVIRONMENT_LAYOUTS = {
    "Mining": {
        ...
        "submissions": {
            "base_dir": "Mining/Submissions",
            "global_dir": "Mining/Submissions",
            "global_file": "global_submission.json",
            "hourly_dir_template": (
                "Mining/Submissions/{year}/{month}/{day}/{hour}"
            ),
    ...
    "Testing/Demo": {
        ...
        "submissions": {
            "base_dir": "Test/Demo/Mining/Submissions",
            "global_dir": "Test/Demo/Mining/Submissions",
            "global_file": "global_submission.json",
            "hourly_dir_template": (
                "Test/Demo/Mining/Submissions/{year}/{month}/{day}/{hour}"
            ),
            "hourly_file": "hourly_submission.json",
        },
        "system": {
            ...
            "brain": {
                ...
                "hourly_dir_template": "Test/Demo/Mining/System/Brain/Hourly/{year}/{month}/{day}/{hour}",
                "files": {
                    "report": "global_brain_report.json",
                    "error": "global_brain_error.json",
                    "log": "global_brain.log",
            ...
            "brainstem": {
                ...
                "hourly_dir_template": "Test/Demo/Mining/System/Brainstem/Hourly/{year}/{month}/{day}/{hour}",
                "files": {
                    "report": "global_brainstem_report.json",
                    "error": "global_brainstem_error.json",
                    "log": "global_brainstem.log",
            ...
            "dtm": {
                ...
                "hourly_dir_template": "Test/Demo/Mining/System/DTM/Hourly/{year}/{month}/{day}/{hour}",
                "files": {
                    "report": "global_dtm_report.json",
                    "error": "global_dtm_error.json",
                    "log": "global_dtm.log",
            ...
            "looping": {
                ...
                "hourly_dir_template": "Test/Demo/Mining/System/Looping/Hourly/{year}/{month}/{day}/{hour}",
                "files": {
                    "report": "global_looping_report.json",
                    "error": "global_looping_error.json",
                    "log": "global_looping.log",
            ...
            "miners": {
                ...
                "hourly_dir_template": "Test/Demo/Mining/System/Miners/Hourly/{year}/{month}/{day}/{hour}",
                "files": {
                    "report": "global_miners_report.json",
                    "error": "global_miners_error.json",
                    "log": "global_miners.log",
        ...
        "system_reports": {
            ...
            "hourly_dir_template": "Test/Demo/Mining/System/System_Reports/Aggregated/Hourly/{year}/{month}/{day}/{hour}",
            "global_file": "global_system_report.json",
            "hourly_file": "hourly_system_report.json",
        },
        "system_errors": {
            "global_dir": "Test/Demo/Mining/System/System_Errors/Aggregated/Global",
            "hourly_dir_template": "Test/Demo/Mining/System/System_Errors/Aggregated/Hourly/{year}/{month}/{day}/{hour}",
            "global_file": "global_system_error.json",
            "hourly_file": "hourly_system_error.json",
        },
    },
    "Testing/Test mode": {
        ...
        "submissions": {
            "base_dir": "Test/Test mode/Mining/Submissions",
            "global_dir": "Test/Test mode/Mining/Submissions",
            "global_file": "global_submission.json",
            "hourly_dir_template": (
                "Test/Test mode/Mining/Submissions/{year}/{month}/{day}/{hour}"
            ),
            "hourly_file": "hourly_submission.json",
        },
        "system": {
            ...
            "brain": {
                ...
                "hourly_dir_template": "Test/Test mode/Mining/System/Brain/Hourly/{year}/{month}/{day}/{hour}",
                "files": {
                    "report": "global_brain_report.json",
                    "error": "global_brain_error.json",
                    "log": "global_brain.log",
            ...
            "brainstem": {
                ...
                "hourly_dir_template": "Test/Test mode/Mining/System/Brainstem/Hourly/{year}/{month}/{day}/{hour}",
                "files": {
                    "report": "global_brainstem_report.json",
                    "error": "global_brainstem_error.json",
                    "log": "global_brainstem.log",
            ...
            "dtm": {
                ...
                "hourly_dir_template": "Test/Test mode/Mining/System/DTM/Hourly/{year}/{month}/{day}/{hour}",
                "files": {
                    "report": "global_dtm_report.json",
                    "error": "global_dtm_error.json",
                    "log": "global_dtm.log",
            ...
            "looping": {
                ...
                "hourly_dir_template": "Test/Test mode/Mining/System/Looping/Hourly/{year}/{month}/{day}/{hour}",
                "files": {
                    "report": "global_looping_report.json",
                    "error": "global_looping_error.json",
                    "log": "global_looping.log",
            ...
            "miners": {
                ...
                "hourly_dir_template": "Test/Test mode/Mining/System/Miners/Hourly/{year}/{month}/{day}/{hour}",
                "files": {
                    "report": "global_miners_report.json",
                    "error": "global_miners_error.json",
                    "log": "global_miners.log",
        ...
        "system_reports": {
            ...
            "hourly_dir_template": "Test/Test mode/Mining/System/System_Reports/Aggregated/Hourly/{year}/{month}/{day}/{hour}",
            "global_file": "global_system_report.json",
            "hourly_file": "hourly_system_report.json",
        },
        "system_errors": {
            "global_dir": "Test/Test mode/Mining/System/System_Errors/Aggregated/Global",
            "hourly_dir_template": "Test/Test mode/Mining/System/System_Errors/Aggregated/Hourly/{year}/{month}/{day}/{hour}",
            "global_file": "global_system_error.json",
            "hourly_file": "hourly_system_error.json",
        },
    },
...
def defensive_write_json(filepath, data, operation_name="write", component="system"):
    ...
    # Layer 1: Try standard write (different approach)
    try:
        import os
        ...
        print(f"✅ Layer 1: Standard write succeeded - {filepath}")
        return True
        
    except Exception as e:
        print(f"⚠️ Layer 1 failed: {e}")
    
    # Layer 2: Try backup directory
    try:
        backup_dir = Path("Mining/Backup_Logs") / component
        backup_dir.mkdir(parents=True, exist_ok=True)
        
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        backup_file = backup_dir / f"backup_{operation_name}_{timestamp}.json"
        
        with open(backup_file, 'w') as f:
            json.dump(data, f, indent=2)
        
        print(f"✅ Layer 2: Backup write succeeded - {backup_file}")
        return True
        
    except Exception as e:
        print(f"⚠️ Layer 2 failed: {e}")
    
    # Layer 3: Simple text log (ULTIMATE FALLBACK - always works)
    try:
        simple_log = Path("Mining/emergency_log.txt")
        simple_log.parent.mkdir(parents=True, exist_ok=True)
        
        with open(simple_log, 'a') as f:
            timestamp = datetime.now().isoformat()
            f.write(f"\n{'='*80}\n")
            f.write(f"[{timestamp}] {component.upper()} - {operation_name}\n")
            f.write(f"Target: {filepath}\n")
            f.write(f"Data: {json.dumps(data, indent=2)}\n")
            f.write(f"{'='*80}\n")
        
        print(f"✅ Layer 3: Emergency log succeeded - {simple_log}")
        return True
        
    except Exception as e:
        print(f"❌ Layer 3 FAILED: {e}")
    
    # Layer 4: Log error but don't crash
    try:
        print(f"❌ ALL LAYERS FAILED for {operation_name}")
        print(f"   Target: {filepath}")
        print(f"   Data keys: {list(data.keys()) if isinstance(data, dict) else 'not dict'}")
        print(f"   Continuing operation - data NOT saved")
    except (OSError, IOError):
        # Stdout/stderr redirect issue - truly silent failure
        pass
...
def _normalize_environment_key(environment):
    ...
    if env in {"demo", "sandbox_demo", "testing/demo", "global/testing/demo"}:
        return "Testing/Demo"
    if env in {"test", "testing", "sandbox", "testing/test", "global/testing/test"}:
        return "Testing/Test"
...
def get_brain_qtl_file_path(file_type, environment="Mining", custom_path=None):
    ...
    components = {"year": year, "month": month, "day": day, "hour": hour}
...
def create_system_error_global_file(error_data, component_name="Unknown", base_path=None):
    ...
    try:
        ...
        # Determine base path (mode-aware)
        if base_path:
            system_errors_dir = Path(base_path) / "System" / "System_Errors"
        else:
            system_errors_dir = Path("System/System_Errors")
        
        system_errors_dir.mkdir(parents=True, exist_ok=True)
        
        global_error_file = system_errors_dir / "global_system_errors.json"
...
def create_system_error_hourly_file(error_data, component_name="Unknown", base_path=None):
    ...
    try:
        ...
        # Determine base path (mode-aware)
        if base_path:
            hourly_errors_dir = Path(base_path) / "System" / "System_Errors" / str(now.year) / f"{now.month:02d}" / f"{now.day:02d}" / f"{now.hour:02d}"
        else:
            hourly_errors_dir = Path("System/System_Errors") / str(now.year) / f"{now.month:02d}" / f"{now.day:02d}" / f"{now.hour:02d}"
        
        hourly_errors_dir.mkdir(parents=True, exist_ok=True)
        
        hourly_error_file = hourly_errors_dir / "hourly_system_errors.json"
...
def create_system_report_global_file(report_data, component_name="System", base_path=None):
    ...
    try:
        ...
        # Determine base path (mode-aware)
        if base_path:
            system_reports_dir = Path(base_path) / "System" / "System_Reports"
        else:
            system_reports_dir = Path("System/System_Reports")
        
        system_reports_dir.mkdir(parents=True, exist_ok=True)
        
        global_report_file = system_reports_dir / "global_system_reports.json"
        ...
        try:
            base_dir = system_reports_dir.parent if base_path else Path("Mining")
...
def create_system_report_hourly_file(report_data, component_name="System", base_path=None):
    ...
    try:
        ...
        # Determine base path (mode-aware)
        if base_path:
            hourly_reports_dir = Path(base_path) / "System" / "System_Reports" / str(now.year) / f"{now.month:02d}" / f"{now.day:02d}" / f"{now.hour:02d}"
        else:
            hourly_reports_dir = Path("System/System_Reports") / str(now.year) / f"{now.month:02d}" / f"{now.day:02d}" / f"{now.hour:02d}"
        
        hourly_reports_dir.mkdir(parents=True, exist_ok=True)
        
        hourly_report_file = hourly_reports_dir / "hourly_system_report.json"
...
def create_initial_tracking_files_from_brain(base_path):
    ...
    def read_example(example_filename):
        """Read structure from System_File_Examples"""
    ...
    # Read all examples (Phase 2: Use Brain-generated examples)
    global_ledger_template = read_example("Ledger_Global_example.json")
    math_proof_template = read_example("Math_Proof_example.json")
    global_submission_template = read_example("Submission_Global_example.json")
    system_report_template = read_example("System_Report_example.json")
    system_error_template = read_example("System_Error_example.json")
    
    # Update timestamps to current time
    timestamp = datetime.now(ZoneInfo("America/Chicago")).isoformat()
    if global_ledger_template and "metadata" in global_ledger_template:
        global_ledger_template["metadata"]["created"] = timestamp
        global_ledger_template["metadata"]["last_updated"] = timestamp
    if math_proof_template and "metadata" in math_proof_template:
        math_proof_template["metadata"]["created"] = timestamp
    if global_submission_template and "metadata" in global_submission_template:
        global_submission_template["metadata"]["created"] = timestamp
        global_submission_template["metadata"]["last_updated"] = timestamp
    ...
    tracking_files = {
        ...
        f"{base_path}/System/System_Logs/Aggregated/Global/global_aggregated.log": ""
    }
...
def load_file_template_from_examples(file_type, component=None):
    ...
    example_map = {
        ...
        'hourly_submission': 'System_File_Examples/Looping/Hourly/hourly_submission_example.json',
    }
...
def aggregate_component_errors(base_dir: str = "Mining/System"):
    ...
    try:
        ...
        # Hourly aggregated error file
        hourly_dir = os.path.join(base_dir, "System_Errors", str(now.year), f"{now.month:02d}", f"{now.day:02d}", f"{now.hour:02d}")
...
def generate_system_report(base_dir: str = "Mining/System"):
    ...
    try:
        ...
        # Write hourly system report
        hourly_dir = os.path.join(base_dir, "System_Reports", str(now.year), f"{now.month:02d}", f"{now.day:02d}", f"{now.hour:02d}")
        os.makedirs(hourly_dir, exist_ok=True)
...
def aggregate_all_component_reports(base_dir="Mining/System"):
    ...
    try:
        ...
        # 7. Read Submissions
        submission_path = Path("Mining/Submissions/global_submission.json")
...
def brain_write_hierarchical(entry_data, base_dir, file_type="ledger", component=None):
    """
    Write to all hierarchical time levels (year/month/week/day + REPORT.txt).
    This is the NATIVE Python implementation - no exec() issues.
    """
    print(f"🔍 DEBUG: brain_write_hierarchical called - base_dir={base_dir}, file_type={file_type}")
    comp = component or _BRAIN_COMPONENT
    now = datetime.now()
    year = str(now.year)
    month = f"{now.month:02d}"
    ...
    print(f"🔍 DEBUG: Date - year={year}, month={month}, week={week}, day={day}, hour={hour}")
    ...
    print(f"🔍 DEBUG: Paths - yd={yd}, md={md}, wd={wd}, dd={dd}")
    ...
    for d in [yd, md, wd, dd, hd]:
        try:
            ...
            print(f"🔍 DEBUG: Created dir {d}")
        except Exception as e:
            print(f"❌ Failed to create dir {d}: {e}")
    
    # Write to each level with TEMPLATE MERGE
    levels = [
        ("year", yd, f"global_{year}.json", "Hierarchical/global_year_example.json"),
        ("month", md, f"global_{month}.json", "Hierarchical/global_month_example.json"),
        ("week", wd, f"global_{week}.json", "Hierarchical/global_week_example.json"),
        ("day", dd, f"global_{day}.json", "Hierarchical/global_day_example.json")
    ]
    
    for level_name, dir_path, filename, template_file in levels:
        file_path = dir_path / filename
        
        # Load template for this level
        template = None
        ...
        try:
            # Determine array key based on file type
            array_key = "entries"  # Default
            if file_type == "submission":
                array_key = "submissions"
            elif file_type == "math_proof":
                array_key = "proofs"
            ...
            if file_path.exists():
                ...
                if template:
                    for key, value in template.items():
                        if key not in data and key not in [array_key, 'entries', 'submissions', 'proofs', 'metadata']:
                            data[key] = value
                    ...
                    if 'metadata' in template:
                        ...
                        for key, value in template['metadata'].items():
                            if key not in data['metadata'] and key not in ['created', 'year', 'month', 'week', 'day']:
                ...
                if template:
                    ...
                    if array_key not in data:
                        data[array_key] = []
                    data['metadata']['created'] = now.isoformat()
                    data['metadata']['level'] = level_name
                    data['metadata']['component'] = comp
                    data['metadata']['mode'] = _BRAIN_MODE
                else:
                    # Fallback
                    data = {
                        array_key: [],
    ...
    # Create REPORT.txt from template
    try:
        # Try to load template
        template_path = Path("System_File_Examples/Hierarchical/REPORT_example.txt")
        if template_path.exists():
            with open(template_path, 'r') as f:
                report_content = f.read()
            
            # Replace placeholders with actual data
            report_content = report_content.replace("{timestamp}", now.strftime('%Y-%m-%d %H:00'))
            report_content = report_content.replace("{component}", comp)
            report_content = report_content.replace("{mode}", _BRAIN_MODE)
            report_content = report_content.replace("{year}", year)
            report_content = report_content.replace("{month}", month)
            report_content = report_content.replace("{day}", day)
            report_content = report_content.replace("{hour}", hour)
            report_content = report_content.replace("{entry_timestamp}", entry_data.get('timestamp', 'N/A'))
            report_content = report_content.replace("{block_hash}", str(entry_data.get('block_hash', 'N/A'))[:40])
            report_content = report_content.replace("{nonce}", str(entry_data.get('nonce', 'N/A')))
            report_content = report_content.replace("{miner_id}", str(entry_data.get('miner_id', 'N/A')))
            report_content = report_content.replace("{leading_zeros}", str(entry_data.get('leading_zeros', 'N/A')))
            report_content = report_content.replace("{base_path}", str(base_dir))
        else:
        ...
        report_path = hd / "REPORT.txt"
        with open(report_path, 'w') as f:
            f.write(report_content)
        results["report"] = {"success": True, "path": str(report_path)}
    except Exception as e:
        results["report"] = {"success": False, "error": str(e)}
        print(f"❌ Failed to create REPORT.txt: {e}")
...
def brain_get_path(file_type, component=None):
    ...
    path_map = {
        ...
        "submission_log": f"{base}/Submission_Logs",  # Renamed: tracks submission history
        "network_submission": f"{base}/Network_Submissions",  # NEW: actual blocks for network
        "math_proof": f"{base}/Ledgers",  # Math proofs stored with ledgers
...
def brain_init_hierarchical_structure(file_type="ledger", component=None):
    """
    Initialize complete hierarchical directory structure with global files at each level.
    This creates: Year/Month/Week/Day folders with global_XXXX.json files at each level.
    Week is stored as YYYY/MM/WW/ (just week number, e.g., 49)
    Called by components (Looping, DTM, Brainstem) to set up their tracking systems.
    """
    comp = component or _BRAIN_COMPONENT
    now = datetime.now()
    year = str(now.year)
    month = f"{now.month:02d}"
    week_num = now.strftime('%W')  # Just the number, e.g., "49"
    day = f"{now.day:02d}"
    
    # Get base path for this file type
    base_path = brain_get_path(file_type, comp)
    bp = Path(base_path)
    
    # Create hierarchical directories
    # Structure: YYYY/MM/WW/ (week as sibling) and YYYY/MM/DD/ (day as sibling)
    yd = bp / year
    md = yd / month
    wd = md / week_num  # Week at same level as day
    dd = md / day
    
    # Create all directories
    for d in [bp, yd, md, wd, dd]:
        d.mkdir(parents=True, exist_ok=True)
    
    # Define hierarchical levels with appropriate file types
    levels = [
        ("year", yd, f"global_{year}.json"),
        ("month", md, f"global_{month}.json"),
        ("week", wd, f"global_{week_num}.json"),
    ...
    for level_name, dir_path, filename in levels:
        ...
        if not file_path.exists():
            # Load template from System_File_Examples instead of hardcoding
            template_map = {
                "ledger": "DTM/Global/global_ledger_example.json",
                "math_proof": "DTM/Global/global_math_proof_example.json",
                "submission_log": "Looping/Global/global_submission_example.json",
                "submission": "Looping/Global/global_submission_example.json",
                "system_report": f"{comp}/Global/global_{comp.lower()}_report_example.json",
                "error_report": f"{comp}/Global/global_{comp.lower()}_error_example.json"
            }
            
            template_file = template_map.get(file_type)
            initial_data = None
            
            # Try to load from System_File_Examples
            if template_file:
                template_path = Path("System_File_Examples") / template_file
                if template_path.exists():
                    try:
                        ...
                        # Clear example entries from template
            ...
            # Fallback if template not found or failed to load
            if initial_data is None:
                initial_data = {
                    "metadata": {
                        "file_type": f"global_{level_name}_{file_type}",
                        "component": comp,
                        "level": level_name,
                        "created": now.isoformat(),
                        "mode": _BRAIN_MODE,
                        "note": "Created without template - using fallback structure"
                    },
                    "entries": []
                }
...
def brain_init_aggregated_index(file_type="ledger", component=None):
    ...
    levels = [
        ...
        ("week", wd, f"aggregated_index_{week_num}.json", f"Contains: Week {week_num} + all days/hours"),
    ...
    for level_name, dir_path, filename, scope in levels:
        file_path = dir_path / filename
        ...
        if not file_path.exists():
            ...
            initial_data = {
                ...
                "summary": {
                    "total_entries": 0,
                    "data_sources": []  # List of files/levels included
                },
                "aggregated_data": {},  # The actual rolled-up data
                "sub_levels": []  # References to child level indices
            }
...
def brain_get_folder_structure():
    ...
    return {
        ...
        "Submissions": {"reports": ["submission"], "errors": False},
        "Temporary Template": {"reports": [], "errors": False},
        "Rejections": {"reports": ["rejection"], "errors": False},
        "User_Look_At": {"reports": [], "errors": False},
        "System/System_Reports/Brain": {
            "reports": ["brain_report", "system_report"],
            "errors": ["brain_error", "system_error"],
            "subfolders": ["Global", "Hourly"]
        },
        ...
        "System/System_Logs/Brain": {
            "reports": ["brain"],
            "errors": False,
            "subfolders": ["Global", "Hourly"]
        },
        "System/System_Logs/Brainstem": {
            "reports": ["brainstem"],
            "errors": False,
            "subfolders": ["Global", "Hourly"]
        },
        "System/System_Logs/DTM": {
            "reports": ["dtm"],
            "errors": False,
            "subfolders": ["Global", "Hourly"]
        },
        "System/System_Logs/Looping": {
            "reports": ["looping"],
            "errors": False,
            "subfolders": ["Global", "Hourly"]
        },
        "System/System_Logs/Miners": {
            "reports": ["miners"],
            "errors": False,
            "subfolders": ["Global", "Hourly", "Daemons"]
        },
        "System/System_Logs/Aggregated": {
            "reports": ["aggregated"],
            "errors": False,
            "subfolders": ["Global"]
        }
...
def brain_get_all_folders_list(mode="live"):
    """
    Returns flat list of ALL folder paths that need to exist.
    Used by brain_initialize_mode() to create all folders.
    """
    ...
    for folder_path, config in structure.items():
        folders.append(f"{base}/{folder_path}")
        if "subfolders" in config:
            for subfolder in config["subfolders"]:
                folders.append(f"{base}/{folder_path}/{subfolder}")
...
def brain_get_base_path_for_mode(mode):
    ...
    paths = {
        ...
        "demo": "Test/Demo/Mining",
        "test": "Test/Test mode/Mining",
        "sandbox": "Mining"  # Sandbox uses same as live but doesn't submit
    }
...
def brain_initialize_mode(mode, component_name):
    ...
    Does:
    1. Sets mode (demo/test/sandbox/live)
    ...
    try:
        ...
        # Step 2: Generate System_File_Examples ONLY if missing or incomplete
        examples_dir = Path("System_File_Examples")
        if not examples_dir.exists():
            print("📁 System_File_Examples missing - Generating from Brain.QTL...")
            generate_system_example_files()
            print("✅ Generated all template files from Brain.QTL")
        else:
            # Check if we have all expected files (106 templates)
            template_count = len(list(examples_dir.rglob("*.json"))) + len(list(examples_dir.rglob("*.txt")))
            if template_count < 106:
                print(f"⚠️  System_File_Examples incomplete ({template_count}/106 files) - Regenerating missing files...")
                generate_system_example_files()
                print("✅ Missing template files generated from Brain.QTL")
            else:
                print(f"✅ System_File_Examples exists ({template_count} files) - Preserving user edits")
        ...
        # Step 6.5: Create root global files from System_File_Examples templates
        print("📄 Creating root global files from templates...")
        base = brain_get_base_path()
        root_files_created = 0
        
        # Ledger root
        ledger_root = Path(f"{base}/Ledgers/global_ledger.json")
        if not ledger_root.exists():
            template = Path("System_File_Examples/global_ledger.json")
            if template.exists():
                import shutil
                ledger_root.parent.mkdir(parents=True, exist_ok=True)
                shutil.copy(template, ledger_root)
                root_files_created += 1
        
        # Math proof root
        math_root = Path(f"{base}/Ledgers/global_math_proof.json")
        if not math_root.exists():
            template = Path("System_File_Examples/global_math_proof.json")
            if template.exists():
                import shutil
                math_root.parent.mkdir(parents=True, exist_ok=True)
                shutil.copy(template, math_root)
                root_files_created += 1
        
        # Submission root
        submission_root = Path(f"{base}/Submissions/global_submission.json")
        if not submission_root.exists():
            template = Path("System_File_Examples/global_submission.json")
            if template.exists():
                import shutil
                # Create parent directory first
                submission_root.parent.mkdir(parents=True, exist_ok=True)
                shutil.copy(template, submission_root)
                root_files_created += 1
        
        print(f"✅ Root global files created: {root_files_created}")
        
        # Step 7: Initialize aggregated indices for all types
        print("🗂️  Initializing aggregated indices...")
        ...
        print("✅ Aggregated indices created")
...
def brain_save_system_report(report_data, component_name, report_type="status"):
    ...
    - EXISTING files: Merge new fields from template (preserves data)
    - Template changes propagate automatically to ALL outputs in ALL modes
    - Updates example file → auto-updates ALL modes (demo/test/sandbox/live)
    """
    try:
        ...
        # Global report
        global_report_path = Path(base_dir) / "Global" / f"global_{component_name.lower()}_report.json"
        ...
        # HOURLY - Also use template structure
...
def brain_save_submission_log(submission_log_data, component_name="Looping"):
    ...
    Path: Mining/System/Submission_Logs/Looping/...
    """
    try:
        # Use a different base path for submission logs
        base_dir = f"Mining/System/Submission_Logs/{component_name}"
        ...
        # Add log entry
        log_file['logs'].append(submission_log_data)
        log_file['metadata']['last_updated'] = datetime.now().isoformat()
        log_file['total_submitted'] = len(log_file['logs'])
        
        # Update counters
        log_file['accepted'] = sum(1 for log in log_file['logs'] if log.get('accepted', False))
        ...
        hourly_log['logs'].append(submission_log_data)
